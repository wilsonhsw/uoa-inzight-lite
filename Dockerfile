...
ENV LAST_BUILD_DATE "Wed Sep 05 01:55:00 NZDT 2016"

# Install (via R) all of the necessary packages (R will automatially install dependencies):
RUN R -e "update.packages(repos = 'http://r.docker.stat.auckland.ac.nz/R/', ask = FALSE, dependencies = TRUE, type = 'source')" \
